      ...
      <ContainerBottom>
        <ContainerValues>
          <ContainerTitleValue>
            ...
            <TextValue>{formatMoney(subTotalPrice)}</TextValue>
          </ContainerTitleValue>
          <ContainerTitleValue>
            <TextTitle>Total de taxas</TextTitle>
            <TextValue>{formatMoney((totalTax = subTotalPrice * 0.1))}</TextValue>
          </ContainerTitleValue>
          <ContainerTitleValue>
            <TextTitle>Código promocional</TextTitle>
            <TextValue>R$ 0,00</TextValue>
          </ContainerTitleValue>
          <ContainerTotalValue>
            <TextTitleTotal>Total</TextTitleTotal>
            <TextValueTotal>{formatMoney((totalPrice = subTotalPrice + totalTax))}</TextValueTotal>
          </ContainerTotalValue>
        </ContainerValues>
        <ContainerCoupon>
          <InputForm
        ...
        <Button title="Continuar" onPress={handleGoToPaymentMethod} />
        <ContainerObservation>
